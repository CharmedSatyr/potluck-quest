...
We are {siteMetadata.companyFull} ("Company," "we," "us," "our"), a company
registered in Washington, United States at:<br/><ContactAddress />

We operate the website {siteMetadata.siteUrl} (the "Site"), as well as any other
related products and services that refer or link to these legal terms (the
"Legal Terms") (collectively, the "Services").

You can contact us by email at <ContactEmail/> or by mail
to:<br/><ContactAddress/>
...
{siteMetadata.companyFull}, concerning your access to and use of the Services.
...
to: <ContactEmail />. If we ever grant you the permission to post, reproduce, or
